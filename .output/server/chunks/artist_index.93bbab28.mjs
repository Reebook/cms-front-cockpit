...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    const { data: artists } = ([__temp, __restore] = withAsyncContext(() => useFetch(`https://cms-una.000webhostapp.com/api/content/items/artistas?fields={"name":true}`, "$SS27HZS6Qq")), __temp = await __temp, __restore(), __temp);
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="container"><h3 style="${ssrRenderStyle({ "margin-top": "15px" })}">Informaci\xF3n de artistas </h3><p>Esta secci\xF3n muestra la lista de los artistas</p><ul><!--[-->`);
      ssrRenderList(unref(artists), (artist) => {
        ...
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`${ssrInterpolate(artist.name)}`);
            } else {
              return [
                createTextVNode(toDisplayString(artist.name), 1)
              ];
            }
          }),
          _: 2
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/artist_index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=artist_index.93bbab28.mjs.map
