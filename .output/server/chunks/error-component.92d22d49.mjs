...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404.06076ac5.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500.c5a1f4ba.mjs'));
...
//# sourceMappingURL=error-component.92d22d49.mjs.map
